...
The famous [Five Monkeys experiment](https://en.wikipedia.org/wiki/Five_monkeys_experiment), a psychological story about social conformity, came to my mind today. I was thinking that I may need to start coding manually again; otherwise, my brain will deteriorate in the age of agentic engineering. Not all the time, but at least sometimes. So maybe I should code some algorithms for fun. I like to write recursive functions. It is very hard, but once it clicks, it works like a charm. It is also impossible to debug, but with the right mindset, you can tame it like a cobra to music.
